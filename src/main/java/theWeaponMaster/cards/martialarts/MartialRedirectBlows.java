...
public class MartialRedirectBlows extends AbstractDynamicCard {

    public static final String ID = TheWeaponMaster.makeID(MartialRedirectBlows.class.getSimpleName());
