...
public class Ego extends AbstractPower implements CloneablePowerInterface {
    ...
    public Ego(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
