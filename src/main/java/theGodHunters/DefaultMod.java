...
import theGodHunters.cards.*;
import theGodHunters.cards.weaponmaster.Defend_WeaponMaster;
import theGodHunters.cards.weaponmaster.Strike_WeaponMaster;
import theGodHunters.cards.weaponmaster.bully.*;
import theGodHunters.cards.weaponmaster.legendary_weapons.atlas.AtlasInkSlash;
import theGodHunters.cards.weaponmaster.legendary_weapons.atlas.LW_Atlas;
import theGodHunters.cards.weaponmaster.legendary_weapons.atropos.AtroposSever;
import theGodHunters.cards.weaponmaster.legendary_weapons.fenrir.FenrirLacerate;
import theGodHunters.cards.weaponmaster.legendary_weapons.fenrir.FenrirShieldEater;
import theGodHunters.cards.weaponmaster.legendary_weapons.fenrir.FenrirUnrestrainedViolence;
import theGodHunters.cards.weaponmaster.legendary_weapons.fenrir.FenrirViciousSwing;
import theGodHunters.cards.weaponmaster.legendary_weapons.revenant.RevenantRavenousStrikes;
import theGodHunters.characters.TheWeaponMaster;
import theGodHunters.events.IdentityCrisisEvent;
import theGodHunters.potions.PlaceholderPotion;
import theGodHunters.relics.BottledPlaceholderRelic;
import theGodHunters.relics.DefaultClickableRelic;
import theGodHunters.relics.PlaceholderRelic;
import theGodHunters.relics.PlaceholderRelic2;
import theGodHunters.util.IDCheckDontTouchPls;
import theGodHunters.util.TextureLoader;
import theGodHunters.variables.DefaultCustomVariable;
import theGodHunters.variables.shieldBuster;
...
// Please don't just mass replace "theGodHunters" with "yourMod" everywhere.
// It'll be a bigger pain for you. You only need to replace it in 3 places.
// I comment those places below, under the place where you set your ID.

//TODO: FIRST THINGS FIRST: RENAME YOUR PACKAGE AND ID NAMES FIRST-THING!!!
// Right click the package (Open the project pane on the left. Folder with black dot on it. The name's at the very top) -> Refactor -> Rename, and name it whatever you wanna call your mod.
// Scroll down in this file. Change the ID from "theGodHunters:" to "yourModName:" or whatever your heart desires (don't use spaces). Dw, you'll see it.
// In the JSON strings (resources>localization>eng>[all them files] make sure they all go "yourModName:" rather than "theGodHunters". You can ctrl+R to replace in 1 file, or ctrl+shift+r to mass replace in specific files/directories (Be careful.).
...
public class DefaultMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "theGodHuntersResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "theGodHuntersResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "theGodHuntersResources/images/512/bg_power_default_gray.png";

    private static final String ENERGY_ORB_DEFAULT_GRAY = "theGodHuntersResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "theGodHuntersResources/images/512/card_small_orb.png";

    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "theGodHuntersResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "theGodHuntersResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "theGodHuntersResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "theGodHuntersResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theGodHuntersResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "theGodHuntersResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "theGodHuntersResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "theGodHuntersResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "theGodHuntersResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    private static final String BADGE_IMAGE = "theGodHuntersResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theGodHuntersResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theGodHuntersResources/images/char/defaultCharacter/skeleton.json";
    ...
    public DefaultMod() {
      ...
      */
        ...
        setModID("theGodHunters");
        // cool
        // TODO: NOW READ THIS!!!!!!!!!!!!!!!:

        // 1. Go to your resources folder in the project panel, and refactor> rename theGodHuntersResources to
        // yourModIDResources.
        
        // 2. Click on the localization > eng folder and press ctrl+shift+r, then select "Directory" (rather than in Project)
        // replace all instances of theGodHunters with yourModID.
        // Because your mod ID isn't the default. Your cards (and everything else) should have Your mod id. Not mine.
        
        // 3. FINALLY and most importantly: Scroll up a bit. You may have noticed the image locations above don't use getModID()
        // Change their locations to reflect your actual ID rather than theGodHunters. They get loaded before getID is a thing.
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addCard(new RevenantRavenousStrikes());
        ...
        UnlockTracker.unlockCard(RevenantRavenousStrikes.ID);
