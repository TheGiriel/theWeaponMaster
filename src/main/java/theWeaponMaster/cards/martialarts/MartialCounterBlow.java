...
public class MartialCounterBlow extends AbstractDynamicCard {

    public static final String ID = TheWeaponMaster.makeID(MartialCounterBlow.class.getSimpleName());
