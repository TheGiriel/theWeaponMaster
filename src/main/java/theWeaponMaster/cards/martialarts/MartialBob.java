...
import theWeaponMaster.cards.tempCards.TemporaryWeave;
import theWeaponMaster.cards.tempCards.TemporaryWeavePreview;
...
public class MartialBob extends AbstractDynamicCard {

    public static final String ID = TheWeaponMaster.makeID(MartialBob.class.getSimpleName());
    ...
    public MartialBob() {
        ...
        purgeOnUse = true;
        this.cardsToPreview = new TemporaryWeavePreview();
