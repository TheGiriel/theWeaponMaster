...
import theGodHunters.cards.OrbSkill;
...
import static theGodHunters.DefaultMod.*;
import static theGodHunters.characters.TheWeaponMaster.Enums.COLOR_GRAY;
...
public class TheWeaponMaster extends CustomPlayer {
    ...
    private static final String ID = makeID("WeaponMaster");
    ...
    public TheWeaponMaster(String name, PlayerClass setClass) {
        super(name, setClass, orbTextures,
                "theGodHuntersResources/images/char/defaultCharacter/orb/vfx.png", null,
    ...
    public Color getCardTrailColor() {
        return theGodHunters.DefaultMod.DEFAULT_GRAY;
    }
