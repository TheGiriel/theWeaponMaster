...
public class RevolverSkillUnload extends AbstractDynamicCard {

    public static final String ID = TheWeaponMaster.makeID(RevolverSkillUnload.class.getSimpleName());
