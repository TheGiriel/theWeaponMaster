...
public class Defend_ArtForger extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Defend_ArtForger.class.getSimpleName());
