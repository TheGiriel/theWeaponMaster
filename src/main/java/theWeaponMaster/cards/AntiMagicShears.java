...
public class AntiMagicShears extends AbstractDynamicCard{

    public static final String ID = DefaultMod.makeID(AntiMagicShears.class.getSimpleName());
