...
public class Defend_EvolvingQueen extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Defend_EvolvingQueen.class.getSimpleName());
