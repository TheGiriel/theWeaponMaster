...
import theWeaponMaster.powers.ProtectingBladePower;
...
public class FenrirProtectingBlade extends AbstractDynamicCard {

    public static final String ID = TheWeaponMaster.makeID(FenrirProtectingBlade.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new ProtectingBladePower(p, block, magicNumber)));
        boolean evolve = true;
