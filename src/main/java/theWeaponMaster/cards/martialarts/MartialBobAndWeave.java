...
public class MartialBobAndWeave extends AbstractDynamicCard implements FlipCard {


    public static final String ID = TheWeaponMaster.makeID(MartialBobAndWeave.class.getSimpleName());
