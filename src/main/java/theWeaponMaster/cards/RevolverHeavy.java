...
public class RevolverHeavy extends AbstractDynamicCard {

    public static final String ID = TheWeaponMaster.makeID(RevolverHeavy.class.getSimpleName());
