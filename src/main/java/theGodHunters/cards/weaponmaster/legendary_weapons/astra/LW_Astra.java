package theGodHunters.cards.weaponmaster.legendary_weapons.astra;
...
public class LW_Astra extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(LW_Astra.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(
                new DamageAction(m, new DamageInfo(p, damage, DamageInfo.DamageType.HP_LOSS),
