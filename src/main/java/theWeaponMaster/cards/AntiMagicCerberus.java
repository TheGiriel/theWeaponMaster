...
public class AntiMagicCerberus extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(AntiMagicCerberus.class.getSimpleName());
