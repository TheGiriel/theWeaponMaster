...
public class MartialGuillotineChoke extends AbstractDynamicCard {


    public static final String ID = TheWeaponMaster.makeID(MartialGuillotineChoke.class.getSimpleName());
