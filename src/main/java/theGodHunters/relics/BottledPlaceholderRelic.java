...
import theGodHunters.patches.relics.BottledPlaceholderField;
import theGodHunters.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theGodHunters.DefaultMod.makeRelicOutlinePath;
import static theGodHunters.DefaultMod.makeRelicPath;
