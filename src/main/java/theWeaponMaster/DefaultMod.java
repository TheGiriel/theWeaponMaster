...
public class DefaultMod implements
    ...
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theWeaponMasterResources/images/charSelect/stupidCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "theWeaponMasterResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "theWeaponMasterResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "theWeaponMasterResources/images/char/defaultCharacter/shoulder2.png";
    ...
    public void receiveEditCards() {
        ...
        //BaseMod.addCard(new AbaddonDrain());
        //BaseMod.addCard(new AbaddonCard2());
        //BaseMod.addCard(new AbaddonCard3());
        //BaseMod.addCard(new AbaddonCard4());
        ...
        //BaseMod.addCard(new AtroposCard5());
        ...
        //BaseMod.addCard(new LeviathanCard4());
        //BaseMod.addCard(new LeviathanCard5());
        //BaseMod.addCard(new LW_Revenant());
        BaseMod.addCard(new RevenantRavenousStrikes());
        //BaseMod.addCard(new RevenantCard2());
        //BaseMod.addCard(new RevenantCard3());
        ...
        //UnlockTracker.unlockCard(LeviathanCard4.ID);
        //UnlockTracker.unlockCard(LeviathanCard5.ID);
        //UnlockTracker.unlockCard(LW_Revenant.ID);
        UnlockTracker.unlockCard(RevenantRavenousStrikes.ID);
        //UnlockTracker.unlockCard(RevenantCard2.ID);
        //UnlockTracker.unlockCard(RevenantCard3.ID);
        //UnlockTracker.unlockCard(RevenantCard4.ID);
