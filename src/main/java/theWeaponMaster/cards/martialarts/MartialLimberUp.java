...
public class MartialLimberUp extends AbstractDynamicCard {

    public static final String ID = TheWeaponMaster.makeID(MartialLimberUp.class.getSimpleName());
