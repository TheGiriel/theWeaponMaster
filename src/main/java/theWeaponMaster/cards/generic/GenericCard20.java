...
public class GenericCard20 extends AbstractDynamicCard {


    public static final String ID = TheWeaponMaster.makeID(GenericCard20.class.getSimpleName());
