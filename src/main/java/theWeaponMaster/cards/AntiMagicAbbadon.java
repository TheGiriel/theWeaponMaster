...
public class AntiMagicAbbadon extends AbstractDynamicCard{

    public static final String ID = DefaultMod.makeID(AntiMagicAbbadon.class.getSimpleName());
