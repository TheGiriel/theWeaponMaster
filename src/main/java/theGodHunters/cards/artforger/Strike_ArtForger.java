package theGodHunters.cards.artforger;
...
public class Strike_ArtForger extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Strike_ArtForger.class.getSimpleName());
