...
public class AnticipationPower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = TheWeaponMaster.makeID(AnticipationPower.class.getSimpleName());
    ...
    public AnticipationPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
