...
public class DesignatePower extends AbstractPower {

    private static final String POWER_ID = "DesignatePower";
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings("DesignatePower");
    ...
    public DesignatePower(AbstractCreature owner, AbstractCreature source, int countDown) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
